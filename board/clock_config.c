...
- {id: TRACE_CLK_ROOT.outFreq, value: 132 MHz, locked: true, accuracy: '0.001'}
...
- {id: CCM_ANALOG.PLL2_PFD0_DIV.scale, value: '18'}
...
- {id: CCM_ANALOG.PLL3_PFD1_DIV.scale, value: '35'}
