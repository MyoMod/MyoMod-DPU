...
const uint32_t FLEXSPI_RAM_LUT[FLEXSPI_RAM_LUT_LENGTH] = {
  ...
  FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DUMMY_RWDS_DDR, 	kFLEXSPI_8PAD, 7, 	 kFLEXSPI_Command_READ_DDR, 	kFLEXSPI_8PAD, 0x02),
  ...
  FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DUMMY_RWDS_DDR, 	kFLEXSPI_8PAD, 7, 	 kFLEXSPI_Command_READ_DDR, 	kFLEXSPI_8PAD, 0x04),
